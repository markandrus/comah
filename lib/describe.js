 ...
 * @api private
 * @instance
 * @param {Doneable} doneabel
 * @returns {Describe}
 */
Describe.prototype.beforeEach = function(doneabel) {
  this._beforeEach = this._beforeEach
    ? this._beforeEach.then(doneable.toLazyPromise(doneabel))
    : doneabel;
  return this;
};
...
Describe.prototype.afterEach = function afterEach(doneable) {
  this._afterEach = this._afterEach
    ? this._afterEach.then(doneable.toLazyPromise(doneable))
    : doneable;
  return this;
};
